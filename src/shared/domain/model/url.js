/**
 * @summary Value object representing a URL within the domain.
 * @author Josue Antonio Flores Apaico (u20201f773)
 *
 * @remarks
 * Ensures that URL values are well-formed. Invalid values are stored as an
 * empty URL instead of throwing, so incomplete external data does not break
 * the domain. It is immutable.
 */
export class Url {
    /** @type {string} */
    #value;
